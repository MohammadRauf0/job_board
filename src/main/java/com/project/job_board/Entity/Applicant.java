...
public class Applicant {
  ...
  // the annotation below signifies a one-to-many relationship with the 'applications' field
  // in the Application class. 'mappedBy' indicates the field in the Application class
  // that owns the relationship.
  // 'cascade' specifies that operations on the 'applications' field should be cascaded
  // to the associated entities (applications). 'orphanRemoval' ensures that orphaned
  // (unreferenced) applications are removed from the database.
  @OneToMany(mappedBy = "applicant", cascade = CascadeType.ALL, orphanRemoval = true)
  @JsonIgnore
  List<Application> applications;

  // a method to add an application to the list of applications for this applicant
